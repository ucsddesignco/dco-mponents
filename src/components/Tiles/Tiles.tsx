...
const Tiles = ({ collapseBreakpoint, count, horizontalJustification = 'center', space = 0, style, verticalAlignment = 'top', children }: TilesProps) => {
	...
	return (
		<>
			<div
				className={clsx('dc-tiles', collapseBreakpoint && 'dc-tiles__breakpoint--' + collapseBreakpoint)}
				style={
					{
						'--count': count,
